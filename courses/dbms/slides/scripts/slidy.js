...
var w3c_slidy = {
  ...
  size_index: 0,
  size_adjustment: 0,
  sizes:  new Array("50%", "60%", "70%", "85%", "100%", "120%", "140%", "170%", "200%"),
...
//        location.href = this.href;
  ...
  resized: function () {
     ...
     if (width != w3c_slidy.last_width || height != w3c_slidy.last_height)
     {
       ...
       if (document.getElementById("all").style.fontSize != w3c_slidy.sizes[w3c_slidy.size_index])
       {
         document.getElementById("all").style.fontSize = w3c_slidy.sizes[w3c_slidy.size_index];
       }
